...
worldbank_gdp = pd.read_csv(
    'F:/TEAN/Portfolio/olympics/data/worldbank_gdp.csv', index_col=0).reset_index(drop = True) 
worldbank_pop = pd.read_csv(
    'F:/TEAN/Portfolio/olympics/data/worldbank_pop.csv', index_col=0).reset_index(drop = True) 
...
worldbank_gdp = worldbank_gdp.drop(['Indicator Name', 'Indicator Code', 'Unnamed: 64'], axis=1)
...
# 10. Add Population
worldbank_pop = worldbank_pop.drop(['Indicator Name', 'Indicator Code', 'Unnamed: 64'], axis=1)
...
worldbank_pop['Population'] = round(worldbank_pop['Population'].divide(1000000), 2)
...
games_total_df['Perc_BMI'] = round(games_total_df.Num_BMI / games_total_df.Entries, 2)
