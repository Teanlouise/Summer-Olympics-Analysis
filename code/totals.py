...
######## THE COUNTRIES #######
# Group all by Year and NOC to create seperate tallies [Total Athletes, Total Entries, Male, Female, Number of Medals]
...
noc_total_df = all_df[['Year', 'NOC', 'Country', 'Host_Country', 'GDP', 'Population']] 
