...
plt.subplot(1,2,1)
ax2 = sns.scatterplot(data=df, y=y, x='Event', hue='NOC', hue_order=hue_order, palette=noc_colors)
...
ax2.annotate("r = {:.2f}".format(least2), xy=(.68, .25), xycoords=ax2.transAxes, rotation=30, color='C7')
